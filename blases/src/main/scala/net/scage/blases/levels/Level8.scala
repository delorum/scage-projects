...
object Level8 extends Level {
  def constructLevel() {
    ...
    new SpikesPolygon(rVec(631, 673), rVec(660, 732), rVec(682, 725), rVec(652, 659))
    new SpikesPolygon(rVec(803, 164), rVec(981, 365), rVec(1008, 349), rVec(829, 134))

    new Star(rVec(719, 701), 7, rInt(30), rInt(15))
    new Star(rVec(144, 129), 7, rInt(30), rInt(15))
  }
