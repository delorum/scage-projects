...
import com.github.dunnololda.scageprojects.blases.levelparts.FlyingWord
...
object BlaseSelector {
  ...
  private val previous_selections = mutable.Stack[DynaBall with Trace {def bursted:Boolean}]()
...
import com.github.dunnololda.scageprojects.blases.BlaseSelector._
