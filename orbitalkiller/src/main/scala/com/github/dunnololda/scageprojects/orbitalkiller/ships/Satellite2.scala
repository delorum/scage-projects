...
abstract class Satellite2(
  ...
  extends PolygonShip(index, "Любопытный", init_coord, init_velocity, init_rotation, ship_designer, true) {
  ...
  val wreck_parts = List(
    ...
    PolygonShape(
      List(DVec(-2.5, 42.5), DVec(-2.5, 37.5), DVec(7.5, 27.5), DVec(2.5, 37.5), DVec(2.5, 42.5)),
      List( // 26 NOT CONVEX
    ...
    PolygonShape(
      List(DVec(27.5, 2.5), DVec(27.5, -2.5), DVec(32.5, -2.5), DVec(37.5, -7.5), DVec(37.5, -2.5)),
      List( // 32 NOT CONVEX
        PolygonShape(List(DVec(-2.5, 42.5), DVec(-2.5, 37.5), DVec(2.5, 37.5), DVec(2.5, 42.5)), Nil),
        PolygonShape(List(DVec(-2.5, 37.5), DVec(7.5, 27.5), DVec(2.5, 37.5)), Nil)
      )
  ...
  val four = new Engine(
    4,
    position = DVec(-62.5, 0.0),
    force_dir = DVec(1.0, 0.0),
    max_power = 10,
    default_power_percent = 1,
    fuel_consumption_per_sec_at_full_power = 4,
    this
  ...
  val seven = new Engine(
    7,
    position = DVec(-2.5, 50.0),
    force_dir = DVec(1.0, 0.0),
    max_power = 10,
    default_power_percent = 1,
    fuel_consumption_per_sec_at_full_power = 4,
  ...
  val docking_points = List(
    new DockingPoints(
      ...
      createOrderedHull(List(16 -> 30, 1 -> 15))
    )
  )
