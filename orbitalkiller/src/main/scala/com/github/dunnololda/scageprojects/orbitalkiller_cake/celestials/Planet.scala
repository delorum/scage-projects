...
import com.github.dunnololda.scage.ScageLibD.{DVec, WHITE, drawLine, drawSlidingLines, openglLocalTransform, openglMove}
import com.github.dunnololda.scageprojects.orbitalkiller_cake.Main.{action, actionIgnorePause, deleteSelf, drawMapMode, player_ship, render, shipOffset}
