...
object Main2048 extends ScageScreenApp("2048", 740, 480) {
  ...
  render {
    ...
    for {
      ...
      print(elem, Vec(20 + (640-40)/8 + x*(640-40)/4, 480-20 - (480-40)/8 - y*(480-40)/4), size = 48, color, align = "center")
    }
    if(!not_lost) print(s"Вы проиграли. Финальный счет: $count. Еще раз: F2", windowCenter, WHITE, align = "center")
