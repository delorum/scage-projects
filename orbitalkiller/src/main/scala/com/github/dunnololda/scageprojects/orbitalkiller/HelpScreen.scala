...
object HelpScreen extends ScageScreen("Help Screen") {
  val s =
    """|Клавиши цифровой клавиатуры (Num Lock = on) - выбор двигателей:
      ...
      |
      |Z, X, V - рисовать/не рисовать пройденную траекторию/будущую траекторию/интерфейс
      |N - вкл/выкл расчета будущей траектории
      |C - стереть рассчитанную будущую траекторию
      |
      |Нажмите Escape
    """.stripMargin
